...
namespace ArtGallerySystem
{
    public partial class Form3 : Form
    {
        ...
        private Label title, artist, price;
        ...
        private void GetData()
        {
            ...
            dbConnection.Open();
            cmd = new MySqlCommand("SELECT artworkImg, title, artist, price FROM `artworks`", dbConnection);
            ...
            while (dataReader.Read())
            {
                ...
                title.Font = new Font("Bahnschrift Condensed", 14, FontStyle.Bold);
                title.ForeColor = Color.FromArgb(236, 236, 236);
                title.Image = Image.FromFile("C:\\Users\\maria\\Desktop\\ArtGalleryProject\\Backgrounds\\PaintingLabelOpacityBG1.png");
                title.Dock = DockStyle.Bottom;
                title.TextAlign = ContentAlignment.MiddleCenter;

                //Add Artist
                artist = new Label();
                artist.Text = dataReader["artist"].ToString();
                artist.Font = new Font("Bahnschrift Condensed", 12, FontStyle.Italic);
                artist.ForeColor = Color.Black;
                artist.Image = Image.FromFile("C:\\Users\\maria\\Desktop\\ArtGalleryProject\\Backgrounds\\PaintingLabelOpacityBG.png");
                artist.Dock = DockStyle.Bottom;
                artist.TextAlign = ContentAlignment.MiddleCenter;

                //Add Price
                price = new Label();
                price.Text = "$ " + dataReader["price"].ToString();
                price.ForeColor = Color.Black;
                price.Image = Image.FromFile("C:\\Users\\maria\\Desktop\\ArtGalleryProject\\Backgrounds\\PaintingLabelOpacityBG3.png");
                //price.Width = 100;
                ...
                //Display Text
                picBox.Controls.Add(title);
                picBox.Controls.Add(artist);
                picBox.Controls.Add(price);
